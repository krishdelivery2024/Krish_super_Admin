    ...
    $fn = new custom_functions; 
		...
		if(isset($_POST['btnEdit'])){
			...
			if(!empty($name)){
				...
				// check update result
				if($update_result==1){
					$error['update_category'] = " <div class='content-header'>
												<span class='label label-success'>Brand updated Successfully</span>
												<h4><small><a  href='brands.php'><i class='fa fa-angle-double-left'></i>&nbsp;&nbsp;&nbsp;Back to Brands</a></small></h4>
												
												</div>";
				}else{
					$error['update_category'] = " <span class='label label-danger'>Failed update Brand</span>";
				}
			}
			}else{
			$error['check_permission'] = " <div class='content-header'>
												<span class='label label-danger'>You have no permission to update Brand</span>
												</div>";
		}
		...
		<?php } ?>
		  ...
		  <div class="col-md-6">
        	...
        	<div class="alert alert-danger topmargin-sm">You have no permission to update brand.</div>
        <?php } ?>
			...
			enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Brand Name</label><?php echo isset($error['name']) ? $error['name'] : '';?>
                      <input type="text" class="form-control"  name="name" value="<?php echo $res[0]['name']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputFile">Brand Image&nbsp;&nbsp;&nbsp;<br>*Please choose square image of larger than 350px*350px & smaller than 550px*550px.</label><?php echo isset($error['image']) ? $error['image'] : '';?>
