<?php 
$page="High Buying Customers Report";
			...
			<div class="box-content">
                ...
                <div class="box-body table-responsive">
                    ...
                    <table id='sales_table' class="table table-hover" data-toggle="table" 
                        data-url="api-firebase/get-bootstrap-table-data.php?table=customers_report"
                        ...
                        <tr>
                            ...
                            <th data-field="action" data-sortable="true" >Orders</th>
