...
<html>
  <head>
    ...
    <!-- Bootstrap 3.3.5 -->
    <link rel="stylesheet" href="..dist/plugin/bootstrap/css/bootstrap.min.css">
    <!-- Font Awesome -->
...
<section id="faq" class="col-md-12">
  ...
  <h3 style="color:#f47c2e;"><?php echo $i.". ".$row['question'];?></h3>
...
<!-- ============================================================= -->
    ...
    <!-- SlimScroll 1.3.0 -->
    <script src="../dist/scripts/jquery.scrollTo.min.js"></script>
  </body>
</html>
