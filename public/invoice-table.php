            ...
            <div class="box-header">
                ...
                <div class="box-tools">
					...
					<ul class="list-inline margin-bottom-0">
							<li class="form-group">
                            From<input class="form-control" type="date" id="from" name="start_date" placeholder="YYYY/MM/DD" value="<?php if(isset($_POST['start_date'])){echo $_POST['start_date'] ; } ?>" required/>
							</li>
							<li class="form-group">
                            To<input class="form-control" type="date" id="to" name="end_date" placeholder="YYYY/MM/DD" value="<?php if(isset($_POST['end_date'])){echo $_POST['end_date'] ; } ?>" required/>
							</li>
							<li class="form-group">
