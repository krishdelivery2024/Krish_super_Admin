...
?>
      ...
      <!-- Content Wrapper. Contains page content -->
		...
		if(empty($keyword)){
			$sql_query = "SELECT id, name,(SELECT name FROM state s WHERE s.id=c.state_id) AS state_name
				FROM city c where name!='Choose Your City'
                ...
                <div class="box-body table-responsive">
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td width="15%"><?php echo $row['state_name'];?></td>
					  <td>
