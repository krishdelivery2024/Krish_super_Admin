...
?>
		...
		if(isset($_POST['btnEdit'])){
		  ...
		  //  echo $_POST['category'];
			...
			if(!empty($name) && empty($error['image'])){
				...
				// check update result
				if($update_result==1){
					$error['update_subcategory'] = " <div class='content-header'>
			...
			$error['update_subcategory'] = " <div class='content-header'>
												<span class='label label-danger'>You are not authorized to edit this subcategory</span>
												<h4><small><a  href='subcategories.php'><i class='fa fa-angle-double-left'></i>&nbsp;&nbsp;&nbsp;Back to Sub Categories</a></small></h4>
	...
	<?php } else { ?>
    <div class="alert alert-danger topmargin-sm">You are not authorized to update this subcategory.</div>
    <?php } ?>
