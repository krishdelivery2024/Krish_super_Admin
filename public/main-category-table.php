...
<div class="content-header">
    <ol class="breadcrumb">
        <a class="btn btn-block btn-default" href="add-main-category.php"><i class="fa fa-plus-square"></i> Add New Main Category</a>
    </ol>
</div>
    <!-- Main row -->
    <div class="row">
            ...
            <div class="box">
                ...
                <div class="box-body table-responsive">
                    <table class="table table-hover" data-toggle="table" id="cateory_list" 
                        data-url="api-firebase/get-bootstrap-table-data.php?table=main_category"
