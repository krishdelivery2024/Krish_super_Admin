			...
			<div class="box-content">
                ...
                <div class="box-body table-responsive">
                    ...
                    <table id='sales_table' class="table table-hover" data-toggle="table" 
                        data-url="api-firebase/get-bootstrap-table-data.php?table=invoice_report"
                        ...
                        <thead>
                        <tr>
                            <th data-field="id" data-sortable="true">Invoice No.</th>
                            <th data-field="invoice_date" data-sortable="true">Invoice_Date</th>
